...
<body>
    ...
    <div class="child" id="signature">
        ...
        <table id="Tabela_01" width="487" height="153" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td rowspan="2">
                    <a href="https://www.clubedeferias.com/">
                        <img src="https://clubedeferias.com/images/emails/clubelogo.png" width="154" height="153" alt="" /></a>
                </td>
                <td colspan="4">
                    <a href="https://www.clubedeferias.com/">
                        <img src="./images/<?= $img ?>" width="333" height="109" alt="" /></a>
                </td>
            </tr>
            <tr>
                <td>
                    <a href="https://www.instagram.com/oclubedeferias/">
                        <img src="https://clubedeferias.com/images/emails/instalogo.png" width="38" height="44" alt="" /></a>
                </td>
                <td>
                    <a href="https://www.facebook.com/clubedeferiasstellabarros/">
                        <img src="https://clubedeferias.com/images/emails/facelogo.png" width="32" height="44" alt="" /></a>
                </td>
                <td>
                    <a href="https://www.youtube.com/channel/UC3cNLeggbFCbIT3zTcGocqw">
                        <img src="https://clubedeferias.com/images/emails/ytlogo.png" width="31" height="44" alt="" /></a>
                </td>
                <td>
                    <a href="https://grupoaguia.com.br/">
                        <img src="http://images-store.us-southeast-1.linodeobjects.com/images/imgnova.webp" width="232" height="44" alt="" /></a>
                </td>
            </tr>
        </table>
        <br>
